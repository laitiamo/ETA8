    ...
    <template v-if="active == 0">
      ...
      >
        ...
        <el-row :gutter="20">
          ...
          <el-col class="subject-info" :span="12" :xs="24">
            <el-form-item label="校级项目分类" prop="CategoryId">
              <el-select
                v-model="FormData.CategoryId"
                placeholder="请选择校级项目分类"
                style="display: block"
              >
                <template v-for="rankEach in SchoolList">
                  <el-option
