    ...
    <el-aside width="auto" v-if="windowWidth >= 720">
      ...
      >
        ...
        <el-submenu index="2">
          ...
          >
          <el-menu-item
            v-if="roleId === 1 || roleId === 3 || roleId === 6"
            index="/eta/review"
            >奖项审核</el-menu-item
          >
        </el-submenu>
        ...
        <template v-if="roleId == 1 || roleId == 2 || roleId == 3">
          <el-submenu index="4">
            <template slot="title">
              <i class="el-icon-s-help"></i>
              <span slot="title" class="menu-title">记录管理</span>
            </template>
            <el-menu-item index="/eta/query-stu">管理学生获奖</el-menu-item>
        ...
        <template v-if="roleId == 1 || roleId == 2 || roleId == 3">
          <el-submenu index="5">
            ...
            <el-menu-item v-if="roleId !== 2" index="/eta/manage-stu"
              >学生管理</el-menu-item
            >
        ...
        <template v-if="roleId == 1 || roleId == 3">
          <el-submenu index="6">
            <template slot="title">
        ...
        <el-submenu index="7">
          ...
          <el-menu-item index="/eta/log" v-if="roleId === 1"
            >操作日志</el-menu-item
          >
